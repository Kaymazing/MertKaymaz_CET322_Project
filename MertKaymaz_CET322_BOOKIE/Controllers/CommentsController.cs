...
namespace MertKaymaz_CET322_BOOKIE.Controllers
{
    public class CommentsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,Detail,CreatedDate,BookId")] Comment comment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,Detail,CreatedDate,BookId")] Comment comment)
        {
            if (id != comment.Id)
            {
                return NotFound();
